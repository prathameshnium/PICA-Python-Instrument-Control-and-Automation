...
===============================================================================
 ...
 PURPOSE:      A graphical dashboard for launching PICA measurement scripts, 
                It is seprate from PICA launcher as this is for an the creation of an exe 
...
class PICALauncherApp:
    ...
    SCRIPT_PATHS = {
        ...
        "K6517B R-T": resource_path("Keithley_6517B/High_Resistance/RT_K6517B_Lakeshore_Frontend_V11p2_5Always.py"), # This file was not provided, but the name seems correct from logs.
        ...
        "Lakeshore Temp Control": resource_path("Lakeshore_350_340/lakeshore350_temp_ramp_Frontend_V6.py"), # This file was not provided, but the name seems correct from logs.
        ...
        "Lock-in AC Measurement": resource_path("Lock_In_Amplifier/AC_Measurement_Frontend_V1.py"), # This file was not provided, but the name seems correct from logs.
