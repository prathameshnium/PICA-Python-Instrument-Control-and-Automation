...
class PICALauncherApp:
    ...
    SCRIPT_PATHS = {
        ...
        "K2400 I-V": resource_path("Keithley_2400/IV_K2400_Frontend_v6.py"),
        ...
        "K6517B I-V": resource_path("Keithley_6517B/High_Resistance/6517B_high_resistance_lakeshore_RT_Frontend_V11p2_5Always.py"),
        ...
        "LCR C-V Measurement": resource_path("LCR_Keysight_E4980A/LCR_CV_Frontend_V2.py"),
        "Lock-in AC Measurement": resource_path("Lock_In_Amplifier/AC_Transport_Frontend_V1.py"),
