...
class Lakeshore350:
    ...
    def __init__(self, visa_address):
        ...
        try:
            ...
            print(
                f"Connection Error: Could not connect to Lakeshore at {visa_address}")
    ...
    while True:
        try:
            ...
            source_voltage = float(
                input("Enter Keithley SOURCE voltage for R measurement (V): "))
            delay = float(
                input("Enter Keithley settling delay between points (s): "))
