"""
Module: PPMS_Dielectric_Master_Tscan_Fscan_E4980A_GUI.py
...
class PPMSMasterGUI:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title(
            f"PPMS Dielectric Master: Tscan + Fscan v{self.PROGRAM_VERSION}"
        )
        ...
        self.log(f"PPMS Dielectric Master v{self.PROGRAM_VERSION} "
                 "initialized. Lakeshore 350 is READ-ONLY (KRDG? only) — "
                 "the PPMS owns all temperature and field control.")
    ...
    def _create_stability_panel(self, parent, row):
        ...
        b.grid(row=7, column=0, columnspan=6, sticky="ew",
               padx=10, pady=(2, 6))
    ...
    def _scan_for_visa(self):
        ...
        try:
            ...
            if ls_pick:
                ...
                self.log(f"Thermometer auto-selected: {ls_pick}")
            if lcr_pick:
