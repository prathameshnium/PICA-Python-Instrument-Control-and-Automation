...
class IVMeasurementApp:
    ...
    def create_input_frame(self):
        ...
        Label(
            ...
            pady=10)
        self.i_entry = Entry(
            self.frame_input, width=20, font=(
                'Helvetica', 16))
        ...
        Label(
            ...
            padx=10,
            pady=10)
        self.file_location_button = Button(
            self.frame_input,
            text="Browse",
            command=self.browse_file_location,
            font=(
                'Helvetica',
                12),
            bg='#3498DB',
    ...
    def create_output_list_frame(self):
        self.frame_output_list = LabelFrame(
            self.root,
            ...
            font=(
                ...
                14,
                'bold'))
        self.frame_output_list.grid(
            row=1, column=1, padx=10, pady=5, sticky="nsew")

    def create_graph_frame(self):
        self.frame_graph = LabelFrame(
            self.root,
            text='Graph',
            bd=4,
            bg='#2C3E50',
    ...
    def my_measure(self):
        try:
            ...
            Label(
                self.frame_output,
                text=f"I value: {I_value}, Step Size: {I_step_value}, Location: {file_location}",
                font=(
                    'Helvetica',
                    12),
                fg='#ECF0F1',
            ...
            list_current = Listbox(
                self.frame_output_list,
            ...
            messagebox.showinfo(
                "Success", f"Data saved successfully at:\n{file_path}")

        except ValueError:
            messagebox.showerror(
                "Error", "Please enter valid numeric values for Current and Step Size.")
