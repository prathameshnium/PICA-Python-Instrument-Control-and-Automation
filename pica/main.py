...
class PICALauncherApp:
    ...
    SCRIPT_PATHS = {
        ...
        # Model 340 twins of every measurement module that used the 350.
        "Lakeshore 340 Step Control": resource_path("lakeshore/T_Control_L340_Step_GUI.py"),
        "Lakeshore 340 Step Control (Advanced)": resource_path("lakeshore/T_Control_L340_Step_GUI_advanced.py"),
        "Lakeshore 340 Sensor Curve Viewer": resource_path("lakeshore/Sensor_Curve_Viewer_L340_GUI.py"),
        "Delta Mode R-T (L340)": resource_path("keithley/delta_mode/Delta_RT_K6221_K2182_L340_T_Control_GUI.py"),
        "Delta Mode R-T (T_Sensing, L340)": resource_path("keithley/delta_mode/Delta_RT_K6221_K2182_L340_Sensing_GUI.py"),
        "K2400 R-T (L340)": resource_path("keithley/k2400/RT_K2400_L340_T_Control_GUI.py"),
        "K2400 R-T (T_Sensing, L340)": resource_path("keithley/k2400/RT_K2400_L340_T_Sensing_GUI.py"),
        "K2400_2182 R-T (L340)": resource_path("keithley/k2400_2182/RT_K2400_K2182_L340_T_Control_GUI.py"),
        "K2400_2182 R-T (T_Sensing, L340)": resource_path("keithley/k2400_2182/RT_K2400_K2182_L340_T_Sensing_GUI.py"),
        "K6517B R-T (L340)": resource_path("keithley/k6517b/High_Resistance/RT_K6517B_L340_T_Control_GUI.py"),
        "K6517B R-T (T_Sensing, L340)": resource_path("keithley/k6517b/High_Resistance/RT_K6517B_L340_T_Sensing_GUI.py"),
        "Pyroelectric Current (L340)": resource_path("keithley/k6517b/Pyroelectricity/Pyroelectric_K6517B_L340_GUI.py"),
        "K197A AC R-T (L340)": resource_path("keithley/k6221_k197a/RT_AC_K6221_K197A_L340_T_Control_GUI.py"),
        "K197A AC R-T (T_Sensing, L340)": resource_path("keithley/k6221_k197a/RT_AC_K6221_K197A_L340_T_Sensing_GUI.py"),
        "SR830 AC R-T (L340)": resource_path("lockin/sr830/RT_AC_K6221_SR830_L340_T_Control_GUI.py"),
        "SR830 AC R-T (T_Sensing, L340)": resource_path("lockin/sr830/RT_AC_K6221_SR830_L340_T_Sensing_GUI.py"),
        "LCR Temp. Scan (T_Control, L340)": resource_path("keysight/Temprature_Scan_L340_E4980A_GUI.py"),
        "LCR Temp. Scan (T_Sensing, L340)": resource_path("keysight/Temprature_Scan_Passive_L340_E4980A_GUI.py"),
        "LCR Temp. Step Freq. Scan (T_Control, L340)": resource_path("keysight/Step_Frequency_Scan_L340_E4980A_GUI.py"),
        "PPMS Sync Freq. Scan (L340)": resource_path("keysight/PPMS_Sync_Freq_Scan_L340_E4980A_GUI.py"),
        "PPMS Dielectric Master (L340)": resource_path("keysight/PPMS_Dielectric_Master_Tscan_Fscan_L340_E4980A_GUI.py"),
        ...
        # One layer below Python: what the machine has installed for talking
        # to instruments (NI-488.2, NI-VISA, Keysight IO) and the driver DLLs
        # themselves, 32- or 64-bit.
        "System and Driver Diagnostics": resource_path("utils/Diagnostics_System_Info_GUI.py"),
        # And below that: which interfaces exist at all -- GPIB cards and
        # USB-GPIB adapters, serial ports, USB controllers, network. It finds
        # interfaces; the Instrument Status window identifies instruments.
        "Communication Interface Diagnostics": resource_path("utils/Diagnostics_Comms_Interfaces_GUI.py"),
    ...
    def create_launcher_panel(self, parent):
        ...
        self._create_suite_frame(left_col,
                                 ...
                                 "Current Driven",
                                 "Instruments: Keithley 6221/2182, Lakeshore 350 / 340 or Cryocon 34",
                                 [("Sweep Mode I-V ",
                                   "Delta Mode I-V Sweep"),
                                  ("Delta Mode R vs. T (T_Control, L350)",
                                   "Delta Mode R-T", "control"),
                                     ("Delta Mode R vs. T (T_Sensing, L350)",
                                      "Delta Mode R-T (T_Sensing)", "sensing"),
                                     ("Delta Mode R vs. T (T_Control, L340)",
                                      "Delta Mode R-T (L340)", "control"),
                                     ("Delta Mode R vs. T (T_Sensing, L340)",
                                      "Delta Mode R-T (T_Sensing, L340)", "sensing"),
        ...
        self._create_suite_frame(left_col,
                                 ...
                                 "Current Driven",
                                 "Instruments: Keithley 2400, Lakeshore 350 / 340 or Cryocon 34",
                                 [("I-V Sweep",
                                   "K2400 I-V"),
                                  ("R vs. T (T_Control, L350)",
                                   "K2400 R-T", "control"),
                                     ("R vs. T (T_Sensing, L350)",
                                      "K2400 R-T (T_Sensing)", "sensing"),
                                     ("R vs. T (T_Control, L340)",
                                      "K2400 R-T (L340)", "control"),
                                     ("R vs. T (T_Sensing, L340)",
                                      "K2400 R-T (T_Sensing, L340)", "sensing"),
        ...
        self._create_suite_frame(left_col,
                                 ...
                                 "Current Driven",
                                 "Instruments: Keithley 2400/2182, Lakeshore 350 / 340 or Cryocon 34",
                                 [("I-V Sweep",
                                   "K2400_2182 I-V"),
                                  ("R vs. T (T_Control, L350)",
                                   "K2400_2182 R-T", "control"),
                                     ...
                                     ("R vs. T (T_Control, L340)",
                                      "K2400_2182 R-T (L340)", "control"),
                                     ("R vs. T (T_Sensing, L340)",
                                      "K2400_2182 R-T (T_Sensing, L340)", "sensing"),
                                     ("R vs. T (T_Sensing, Cryocon 34)",
        ...
        self._create_suite_frame(right_col,
                                 ...
                                 "Voltage Driven",
                                 "Instruments: Keithley 6517B, Lakeshore 350 / 340 or Cryocon 34",
                                 [("I-V Sweep",
                                   "K6517B I-V"),
                                  ("R vs. T (T_Control, L350)",
                                   "K6517B R-T", "control"),
                                     ...
                                     ("R vs. T (T_Control, L340)",
                                      "K6517B R-T (L340)", "control"),
                                     ("R vs. T (T_Sensing, L340)",
                                      "K6517B R-T (T_Sensing, L340)", "sensing"),
                                     ("R vs. T (T_Sensing, Cryocon 34)",
        ...
        self._create_suite_frame(
            right_col, 'Pyroelectric Measurement (Keithley 6517B)', "Current Sensing", None, [
                ("PyroCurrent vs. T (L350)", "Pyroelectric Current"),
                ("PyroCurrent vs. T (L340)", "Pyroelectric Current (L340)"),
        ...
        self._create_suite_frame(right_col,
                                 'Temperature Utilities (Lakeshore 350 / 340 / Cryocon 34)',
                                 "Control Utility",
                                 None,
                                 [("Temperature Ramp (L350)",
                                   "Lakeshore Temp Control", "control"),
                                  ("Temperature Ramp (L340)",
                                   "Lakeshore 340 Temp Control", "control"),
                                  ("Step-wise Control (Basic, L350)",
                                   "Lakeshore Step Control", "control"),
                                  ("Step-wise Control (Basic, L340)",
                                   "Lakeshore 340 Step Control", "control"),
                                  ("Step-wise Control (Advanced, L350)",
                                   "Lakeshore Step Control (Advanced)", "control"),
                                  ("Step-wise Control (Advanced, L340)",
                                   "Lakeshore 340 Step Control (Advanced)", "control"),
                                  ("Direct Control (L350)",
                                   "Lakeshore Direct Control", "control"),
                                  ("Direct Control (L340)",
                                   "Lakeshore 340 Direct Control", "control"),
                                  ("Temperature Monitor (L350)",
                                   "Lakeshore Temp Monitor", "sensing"),
                                  ("Temperature Monitor (L340)",
                                   "Lakeshore 340 Temp Monitor", "sensing"),
                                  ...
                                  ("Sensor Curve Viewer (L340, read only)",
                                   "Lakeshore 340 Sensor Curve Viewer", "sensing"),
        ...
        self._create_suite_frame(right_col,
                                 ...
                                 [("C-V Measurement",
                                  ...
                                  ("Dielectric Master Tscan+Fscan (PPMS, L340)", "PPMS Dielectric Master (L340)", "master"),
                                  ("Dielectric Master Tscan+Fscan (PPMS, Cryocon 34)", "PPMS Dielectric Master (CC34)", "master"),
                                  ("Dielectric Temp. Scan (T_Control, L350)", "LCR Temp. Scan (T_Control)", "control"), # Already present
                                  ("Dielectric Temp. Scan (T_Control, L340)", "LCR Temp. Scan (T_Control, L340)", "control"),
                                  ("Dielectric Temp. Scan (T_Sensing, L350)", "LCR Temp. Scan (T_Sensing)", "sensing"), # Already present
                                  ("Dielectric Temp. Scan (T_Sensing, L340)", "LCR Temp. Scan (T_Sensing, L340)", "sensing"),
        ...
        self._create_suite_frame(right_col,
                                 ...
                                 [("Comms and Control",
                                  ...
                                  ("AC Frequency Scan",
                                   "SR830 AC Freq. Scan"),
                                  ("AC R vs. T (T_Control, L350)",
                                   "SR830 AC R-T", "control"),
                                  ("AC R vs. T (T_Sensing, L350)",
                                   "SR830 AC R-T (T_Sensing)", "sensing"),
                                  ("AC R vs. T (T_Control, L340)",
                                   "SR830 AC R-T (L340)", "control"),
                                  ("AC R vs. T (T_Sensing, L340)",
                                   "SR830 AC R-T (T_Sensing, L340)", "sensing"),
        ...
        self._create_suite_frame(right_col,
                                 ...
                                 [("AC I-V Sweep", "K197A AC I-V"),
                                  ...
                                  ("AC R vs. T (T_Control, L340)",
                                   "K197A AC R-T (L340)", "control"),
                                  ("AC R vs. T (T_Sensing, L340)",
                                   "K197A AC R-T (T_Sensing, L340)", "sensing"),
                                  ("AC R vs. T (T_Sensing, Cryocon 34)",
