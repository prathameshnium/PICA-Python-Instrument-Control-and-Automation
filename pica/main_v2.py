...
CATALOG = [
    ...
    },
    {
        ...
        'modules': [
            ...
            ("R vs. T (T Sensing)", "K6517B R-T (T_Sensing)", "sensing"),
        ],
    },
    {
    ...
    },
    {
        ...
        'instruments': "Lakeshore 350",
        'modules': [
            ("Temperature Ramp", "Lakeshore Temp Control", "control"),
            ("Step-wise Control (Basic)", "Lakeshore Step Control", "control"),
            ("Step-wise Control (Advanced)", "Lakeshore Step Control (Advanced)", "control"),
            ("Direct Control", "Lakeshore Direct Control", "control"),
            ("Temperature Monitor", "Lakeshore Temp Monitor", "sensing"),
        ],
    },
    {
