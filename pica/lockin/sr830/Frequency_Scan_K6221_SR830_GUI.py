"""
===============================================================================
 PROGRAM:      AC Frequency Scan - Keithley 6221 + SR830
...
PROGRAM_VERSION = "1.0"
MODULE_NAME = "Frequency_Scan_K6221_SR830_GUI.py"
PROGRAM_TITLE = "AC Frequency Scan - Keithley 6221 + SR830"
FILE_SUFFIX = "AC_Fscan"
...
DRIVE_HINT = (
    ...
    "frequency is stepped. The 6221 generates 1 mHz to 100 kHz; the "
    "SR830 external reference reaches 102 kHz, so the 6221 sets the "
    "top end.")
...
INFO_TEXT = (
    "Program: AC frequency scan (four probe)\n"
    ...
    "\n"
    "A flat R(f) is a resistance. A rising or falling one is\n"
    "cable capacitance, contact impedance, or the measurement's\n"
    "own limits -- not the sample's DC resistance.")
...
class ACFrequencyScanGUI:
    ...
    def create_drive_frame(self, parent):
        ...
        row = self._add_entry(frame, row, 'sweep_start',
                              "Start frequency (Hz)", "10.0")
        row = self._add_entry(frame, row, 'sweep_stop',
                              "Stop frequency (Hz)", "10000.0")
