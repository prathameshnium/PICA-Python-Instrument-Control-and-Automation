"""
Module: RT_K2400_K2182_CC34_T_Sensing_GUI.py
Purpose: GUI module for RT K2400 2182 CC34 T Sensing GUI v1.

         Cryocon Model 34 equivalent of
         RT_K2400_K2182_L350_T_Sensing_GUI.py. Measurement logic is
         unchanged: the Keithley 2400 sources a DC current and the Keithley
         2182 nanovoltmeter measures the voltage, while temperature is
         logged passively. Only the thermometry differs -- temperature comes
         from Cryocon input channel A instead of Lakeshore 350 input A.
...
# -------------------------------------------------------------------------------
# Name:         R-T Sweep Passive GUI for K2400/2182 & Cryocon 34
...
class VT_Backend_Passive:
    ...
    def connect(self, k2400_visa, k2182_visa, cc_visa):
        if not self.rm:
        ...
        self.cryocon = self.rm.open_resource(cc_visa)
        self.cryocon.timeout = 10000
        print(
            f"  Cryocon Connected: {self.cryocon.query('*IDN?').strip()}")
        self._verify_units()
...
class VT_GUI_Passive:
    ...
    def create_widgets(self):
        ...
        ttk.Label(
            header,
            text="K2400/2182 & Cryocon 34: R-T (T-Sensing)",
            style='Header.TLabel',
    ...
    def _create_info_panel(self, parent, grid_row):
        ...
        details_text = ("Program Name: R vs. T (T-Sensing)\n"
                        "Instruments: K2400, K2182, Cryocon 34\n"
    ...
    def set_ui_state(self, running: bool):
        ...
        for cb in [self.cc_cb, self.k2400_cb, self.k2182_cb]:
