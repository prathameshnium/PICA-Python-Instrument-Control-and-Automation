"""
Module: RT_K2400_L340_T_Sensing_GUI.py
Purpose: R-T (Keithley 2400) with passive temperature sensing from a
         Lake Shore Model 340.
         Port of RT_K2400_L350_T_Sensing_GUI.py to the Model 340 command
         set.  The Keithley 2400 logic is untouched; only the Lake Shore
         side changes.
...
class RT_Backend_Passive:
    ...
    def get_measurement(self, sensor='A'):
        ...
        # Kelvin reading plus RDGST? status (printed 9-41) so an
        # out-of-range 0.000 K is never taken as a real reading.
...
class RT_GUI_Passive:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("K2400 & L340: R-T (T-Sensing)")
    ...
    def _create_params_panel(self, parent, grid_row):
        ...
        self.sensor_cb.grid(
            row=2, column=1, sticky='ew', padx=10, pady=3, columnspan=3)
        ...
        self.heater_off_cb.grid(
            row=3, column=0, columnspan=4, sticky='w', padx=10, pady=(3, 6))
