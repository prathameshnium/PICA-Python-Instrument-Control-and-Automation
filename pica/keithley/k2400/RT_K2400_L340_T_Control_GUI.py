"""
Module: RT_K2400_L340_T_Control_GUI.py
Purpose: R vs T sweep (Keithley 2400) with the temperature ramp driven by a
         Lake Shore Model 340 (heater range 5).
         Port of RT_K2400_L350_T_Control_GUI.py to the Model 340 command set.
...
class RT_Backend_Active:
    """ Manages communication with the K2400 and Lakeshore 340. """
    ...
    def connect(self, k2400_visa, ls_visa, control_input='A'):
        if not self.rm:
    ...
    def configure_instruments(self, current_ma, compliance_v):
        ...
        read.  Keithley: unchanged.  Returns the CLIMIT? dict."""
...
class RT_GUI_Active:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title(
            f"K2400 & L340: R-T Sweep (T-Control) v{self.PROGRAM_VERSION}")
    ...
    def create_widgets(self):
        ...
        ttk.Label(
            header,
            text="K2400 & L340: R-T Sweep (T-Control)",
            style='Header.TLabel',
    ...
    def _create_info_panel(self, parent):
        ...
        details_text = ("Program Name: R vs. T (T-Control)\n"
                        "Instruments: Keithley 2400, Lakeshore 340\n"
    ...
    def _create_params_panel(self, parent):
        ...
        self.input_cb.grid(row=4, column=1, sticky='w', padx=10, pady=3)
