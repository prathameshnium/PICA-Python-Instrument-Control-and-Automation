...
def main():
    ...
    print("[INFO] This interface has no identify query. The reply was checked "
          "for a meter-like shape, which rules out a modern SCPI instrument "
          "at this address but does not prove the meter is specifically a "
          "197A.")
