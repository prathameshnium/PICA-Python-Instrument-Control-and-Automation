...
class LakeshoreRampGUI:
    ...
    def create_header(self):
        ...
        Label(header_frame, text="Lakeshore 350 Temperature Ramp Control", bg=self.CLR_HEADER, fg=self.CLR_ACCENT_GOLD, font=font_title_main).pack(side='left', padx=20, pady=10)
    ...
    def create_info_frame(self, parent):
        ...
        # Program details
        details_text = ("Program Name: Temperature Ramp\n"
