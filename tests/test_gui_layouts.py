...
Task Attempts to build the GUI windows in memory. It uses a "Safe" mock for Matplotlib to prevent graphing errors from crashing the test, ensuring the layout logic is sound.
"""
import pytest
import os
import sys
